...
button.addEventListener('click', function (e) { */
    fetch(API_URL)
        ...
        .then(data => {
            console.log(data);
            var d = new Date();
            //let responseofWeatherHours = "https://api.openweathermap.org/data/2.5/forecast?q=Brussels&appid=f6211bc24c258c57f7a7fba887afdd17";
            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="card-text">${data.dt_txt.2020-04-28 12:00:00}</p>
