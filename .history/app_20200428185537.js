...
fetch(API_URL_Hrs)
    ...
    .then(data => {
        let hour = data.list;
        var h1 = hour[0].sys.dt_txt.getHours();
        var h2 = hour[1].sys.dt_txt.getHours();
        var h3 = hour[2].sys.dt_txt.getHours();
        var h4 = hour[3].sys.dt_txt.getHours();
        var h5 = hour[4].sys.dt_txt.getHours();
        hours.innerHTML += `
